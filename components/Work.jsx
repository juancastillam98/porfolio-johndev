    ...
    return (
        <section className={"relative mb-12 xl:mb-48"}>
            <div className={"container mx-auto"}>
                <div className={"max-w-[350px] mx-auto xl:mx-0 text-center xl:mx-0 text-center xl:text-left mb-12 xl:h-[400px] flex flex-col justify-center items-center xl:items-start"}>
